                                        ...
                                        while ($row = $result->fetch_object()) {
                                            ...
                                            <div class='dropdown'>
                                                ...
                                                <div class='dropdown-menu' aria-labelledby='dropdownMenuButton'>
                                                    ...
                                                    <a class='dropdown-item' href='#' onclick='confirmDelete({$row->id_alternative})'>Hapus</a>
                                                    </div>
                                                </div>
                                                </td>
                                        </tr>\n";
                ...
                <form action="alternatif-simpan.php" method="POST">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <input autofocus type="text" name="name" placeholder="Nama Siswa" class="form-control" required>
                        </div>
                        <label>Nomor NIS: </label>
                        <div class="form-group">
                            <input autofocus type="text" name="nis" placeholder="Nomor NIS" class="form-control" required>
                        </div>
                        <label>Kelas: </label>
                        <div class="form-group">
                            <input autofocus type="text" name="kelas" placeholder="Kelas" class="form-control" required>
                        </div>
                    </div>
