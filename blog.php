                    ...
                    <div class="col-lg-12">
                        <div class="banner_content text-center">
                            ...
                            <h2 class="text-uppercase mt-4 mb-5">
                                Sistem Penilaian Siswa Menggunakan Metode SAW
                            </h2>
                            <div>
                                <a href="login.php" class="primary-btn2 mb-3 mb-sm-0">Log In</a>
                                <a href="register.php" class="primary-btn ml-sm-3 ml-0">Sign UP</a>
                            </div>
                        </div>
                    </div>
                </div>
