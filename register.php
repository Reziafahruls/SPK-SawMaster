...
<head>
    ...
    <!-- <link rel="icon" type="image/png" href="assets2/img/logo.png"> -->
    ...
    <!-- css datepicker -->
    <link href="assets2/vendor/datepicker/css/bootstrap-datepicker.css" rel="stylesheet">
...
<body class="bg-gradient-primary">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="register-act.php" method="POST">
    ...
    <!-- js datepicker -->
    <script src="assets2/vendor/datepicker/js/bootstrap-datepicker.min.js"></script>
